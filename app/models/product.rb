class Product < ApplicationRecord
  ...
  enum incandescent_lamp_load_max: [:other_incandescent_lamp_load_max, :w2000, :w2300]
  enum fluorescent_lamp_load: [:other_fluorescent_lamp_load, :fll1150va]
  enum led_lamp_load_max: [:other_led_lamp_load_max, :max_lll150w, :max_lll200w, :max_lll300w, :max_lll400w, :max_lll500]
